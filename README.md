...
An iOS app developed for studying, never stop studying, always move forward.
...
- [x] **Predefined Tip Options**: Quick selection buttons for 10%, 15%, 20%, and 25%.
...
```sh
$ git@github.com:diggosilva/CalculadoraGorjeta.git
```

After cloning, do the following:

```sh
$ cd <diretorio-base>/CalculadoraGorjeta/
$ open CalculadoraGorjeta.xcodeproj/
```
